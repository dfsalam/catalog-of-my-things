...
**[Catalog of my things]** is a console app project, that will help you to keep a record of different types of things you own: books, music albums, and games. The data will be stored in JSON files.
...
<details>
<summary>Catalog of my things app built with Ruby.</summary>
...
- [Store information in a real database] 
...
Feel free to check the [issues page](https://github.com/dfsalam/catalog-of-my-things/issues).
